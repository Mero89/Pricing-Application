...
#
# Created: Wed Aug  6 09:54:38 2014
...
class Ui_ImportForm(object):
    def setupUi(self, ImportForm):
        ...
        self.pushButton_courbe = QtGui.QPushButton(self.tab_courbe)
        self.pushButton_courbe.setObjectName(_fromUtf8("pushButton_courbe"))
        self.horizontalLayout.addWidget(self.pushButton_courbe)
        self.pushButton_quitter = QtGui.QPushButton(self.tab_courbe)
        self.pushButton_quitter.setObjectName(_fromUtf8("pushButton_quitter"))
        self.horizontalLayout.addWidget(self.pushButton_quitter)
        ...
        self.pushButton_courbe_multi = QtGui.QPushButton(self.tab_courbe_multi)
        self.pushButton_courbe_multi.setObjectName(_fromUtf8("pushButton_courbe_multi"))
        self.horizontalLayout_2.addWidget(self.pushButton_courbe_multi)
        ...
        QtCore.QObject.connect(self.pushButton_quitter, QtCore.SIGNAL(_fromUtf8("clicked()")), ImportForm.close)
        QtCore.QMetaObject.connectSlotsByName(ImportForm)
        ImportForm.setTabOrder(self.DateEditTaux, self.pushButton_courbe)
        ImportForm.setTabOrder(self.pushButton_courbe, self.pushButton_quitter)
        ImportForm.setTabOrder(self.pushButton_quitter, self.DateEditDateDebut)
        ImportForm.setTabOrder(self.DateEditDateDebut, self.DateEditDateFin)
        ImportForm.setTabOrder(self.DateEditDateFin, self.pushButton_courbe_multi)
        ImportForm.setTabOrder(self.pushButton_courbe_multi, self.pushButton_4)
    ...
    def retranslateUi(self, ImportForm):
        ...
        self.pushButton_courbe.setText(_translate("ImportForm", "Charger La courbe", None))
        self.pushButton_quitter.setText(_translate("ImportForm", "Quitter", None))
        ...
        self.pushButton_courbe_multi.setText(_translate("ImportForm", "Charger Les courbes", None))
